---
title: "Exploring the Drivers of Student Academic Performance: A Visual Analytics Approach"
...
```{r}
ggplot(learning_data, aes(x = GPA, y = as.numeric(Competitive_Class))) +
...
This project used visual analytics to explore how different factors relate to student academic performance. The visual sequence showed that performance patterns cannot be attributed to a single variable; instead, they reflect the combined influence of effort, learning strategies, and perceived educational support. The correlation structure show us that these factors interact rather than operate independently.
